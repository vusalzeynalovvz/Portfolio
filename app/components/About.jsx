      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            privilege of collobrating with prestigious
            ...
            {infoList.map(({ icon, iconDark, title, description }, index) => {
              return (
                <li
                  ...
                  hover:bg-[#fcf4ff] hover:shadow-[4px_4px_0_0_#000] hover:-translate-y-2 duration-500"
                  key={index}
                >
            ...
            {toolsData.map((tool, index) => {
              return (
                <li
                  ...
                  border boder-gray-400 rounded-lg cursor-pointer hover:-translate-y-2 duration-500"
                  key={index}
                >
